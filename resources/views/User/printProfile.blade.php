    ...
    <style>
        ...
        * {
        ...
        .profile-image-placeholder {
            ...
            height: 100px;
            border-radius: 50%;
            background: linear-gradient(135deg, #3773B8, #1e40af);
            display: flex;
            align-items: center;
        ...
        .total-leaves-badge .number {
            font-size: 28pt;
            font-weight: bold;
            color: #2563eb;
        }

        .total-leaves-badge .label {
            font-size: 8pt;
            color: #64748b;
            margin-top: 5px;
        }
        ...
        .leave-column-header.approved {
            background-color: #10b981;
        }

        .leave-column-header.pending {
            background-color: #f59e0b;
        }

        .leave-column-header.rejected {
...
<body>
        ...
        <div class="profile-info">
            <div class="profile-image">
                @if($employee && $employee->profile_image)
                    <img src="{{ asset('storage/' . $employee->profile_image) }}" alt="Profile">
                @else
                    <div class="profile-image-placeholder">{{ substr($user->name, 0, 1) }}</div>
                @endif
            </div>
            ...
            <div class="profile-details">
                ...
                @if($employee)
                    ...
                    <div class="profile-detail-row">
                        <strong>Leave Year:</strong> {{ $employee->leave_year ?? date('Y') }}
                    </div>
                    <div class="profile-detail-row">
            ...
            @if($employee)
                <div class="total-leaves-badge">
                    <div class="number">{{ $employee->total_leave ?? 0 }}</div>
                    <div class="label">Total Leaves Taken</div>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="leave-grid">
        ...
        <div class="leave-column">
            ...
            <div class="leave-items">
                    ...
                    <div class="leave-card approved">
                        ...
                        <div class="leave-card-details">
                            ...
                            <div class="leave-card-row">
                                ...
                                <span><strong>{{ \Carbon\Carbon::parse($leave->leave_from)->diffInDays(\Carbon\Carbon::parse($leave->leave_to)) + 1 }} days</strong></span>
                            </div>
                            @if($leave->reason)
                ...
                @empty
                    <div class="no-leaves">No approved leaves</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="leave-column">
            <div class="leave-column-header pending">
            ...
            <div class="leave-items">
                ...
                @empty
                    <div class="no-leaves">No pending leaves</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="leave-column">
            <div class="leave-column-header rejected">
            ...
            <div class="leave-items">
                ...
                @empty
                    <div class="no-leaves">No rejected leaves</div>
                @endforelse
            </div>
        </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>B-KELANA International - Employee Leave Management System</p>
        <p>This is an official employee profile document - Confidential</p>
    </div>
